...
// class VoucherBuyNowPaymentScreen extends StatefulWidget {
//   final int quantity;
//   final String addressId;
//   final VoucherDetailModel voucher;
//   const VoucherBuyNowPaymentScreen(
...
//   @override
//   State<VoucherBuyNowPaymentScreen> createState() =>
//       _VoucherBuyNowPaymentScreenState();
// }

// class _VoucherBuyNowPaymentScreenState
//     extends State<VoucherBuyNowPaymentScreen> {
// //  List<DeliveryChargeRequestProduct> products;
//   @override
//   void initState() {
//     WidgetsBinding.instance.addPostFrameCallback((_) {
//       Provider.of<DeliveryFeeProvider>(context, listen: false)
//           .fetchDeliveryFee();
//       // Provider.of<DeliveryFeeProvider>(context, listen: false).fetchDeliveryCharge(products)
//     });
...
//               ? widget.voucher.data![0].amount! * (discountValue / 100)
//               : discountValue;
//           if (discount > widget.voucher.data![0].amount!) {
...
//     print("-------${widget.voucher.data![0].id}");
//     return Scaffold(
...
//               child: Consumer2<CheckOutProvider, DeliveryFeeProvider>(
//             builder: (context, checkoutValue, deliveryFeeValue, child) {
//               if (deliveryFeeValue.isLoading) {
//                 return CircularProgressIndicator();
//               }
//               return Consumer<CouponProvider>(
//                 builder: (context, couponProvider, child) {
//                   double subTotal =
//                       double.parse(widget.voucher.data![0].priceAfterDiscount!);
//                   double totalAmount = subTotal -
//                       discount +
//                       double.parse(deliveryFeeValue.deliveryFee!.data.value);
...
//                                 const Spacer(),
//                                 Text(
//                                   "${widget.voucher.data![0].amount!} QAR",
//                                   style: TextStyle(
//                                       fontWeight: FontWeight.w600,
...
//                                 const Spacer(),
//                                 Text(
//                                   "-${widget.voucher.data![0].discount} QAR",
//                                   style: TextStyle(
//                                       fontWeight: FontWeight.w600,
//                                       color: const Color(0xFFC3C6C9),
//                                       fontFamily: 'Segoe',
...
//                                 const Spacer(),
//                                 Text(
//                                   "${deliveryFeeValue.deliveryFee!.data.value} QAR",
//                                   style: TextStyle(
//                                       fontWeight: FontWeight.w600,
//                                       color: const Color(0xFFC3C6C9),
//                                       fontFamily: 'Segoe',
...
//                                   "product_id": widget.voucher.data![0].id,
//                                   // "product_id":
//                                   // "name": widget.product.data?.name,
//                                   "price": widget.voucher.data![0].amount!,
//                                   "quantity": 1,
//                                   "type": 2
//                                 };
